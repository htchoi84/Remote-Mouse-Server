...
class DaumPotPlayer_handler
{
private:
	RXCMD DaumPotPlayer_RX;  //RXdata 저장할 구조체변수
public:
	DaumPotPlayer_handler(void);
	~DaumPotPlayer_handler(void);
	void DaumPotPlayerCMD_Parsing(RXCMD RX_Data); //remote-cmd= 헤더로 시작되는 커맨드들 parsing하는 함수
