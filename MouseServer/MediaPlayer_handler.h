...
class MediaPlayer_handler
{
private:
	RXCMD Mediaplayer_RX;  //RXdata 저장할 구조체변수
public:
	MediaPlayer_handler(void);
	~MediaPlayer_handler(void);
	void MediaplayerCMD_Parsing(RXCMD RX_Data); //remote-cmd= 헤더로 시작되는 커맨드들 parsing하는 함수
